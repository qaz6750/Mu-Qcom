...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/h7000Pkg
  SUPPORTED_ARCHITECTURES        = AARCH64
  BUILD_TARGETS                  = RELEASE|DEBUG
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = h7000Pkg/h7000.fdf
  DISPLAY_USES_RGBA              = 0
  USE_DISPLAYDXE                 = 0
  AB_SLOT_SUPPORT                = 0
...
[LibraryClasses.common]
  DeviceMemoryMapLib|h7000Pkg/Library/DeviceMemoryMapLib/DeviceMemoryMapLib.inf
  DeviceConfigurationMapLib|h7000Pkg/Library/DeviceConfigurationMapLib/DeviceConfigurationMapLib.inf
