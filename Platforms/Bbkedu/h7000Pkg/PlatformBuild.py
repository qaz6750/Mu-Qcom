...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("h7000Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('h7000', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "h7000", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "h7000Pkg/h7000.dsc", "Platform Hardcoded")
