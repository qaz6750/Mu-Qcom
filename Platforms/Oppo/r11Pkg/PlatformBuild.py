# @file
# Script to Build Oppo Mi Max 3 UEFI firmware
#
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "r11", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "r11Pkg/r11.dsc", "Platform Hardcoded")
